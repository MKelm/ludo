...
LO.Player = function(game, color) {
  ...
  this.pieces = [
    { fieldId: -10, sprite: null, move: [] },
    { fieldId: -9, sprite: null, move: [] },
    { fieldId: -8, sprite: null, move: [] },
    { fieldId: -7, sprite: null, move: [] }
  ];
  this.activePieces = 0;

  this.dice = { value: 0, throws: 0, sprite: null };
}
...
LO.Player.prototype.throwDice = function() {
  if (this.activeMove == false) {
    ...
    } else if (this.activePieces == 0 && this.dice.throws == 3) {
