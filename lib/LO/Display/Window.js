...
LO.DisplayWindow = function(game, width, height) {
  this.handle = "default";
  this.game = game;
  this.width = width;
  this.height = height;
...
LO.DisplayWindow.prototype.constructor = LO.DisplayWindow;

LO.DisplayWindow.prototype.initialize = function() {
  this.container = new PIXI.DisplayObjectContainer();
  this.container.position = {x: -1 * this.width/2, y: -1 * this.height/2 };
  this.game.display.container.addChild(this.container);
}

LO.DisplayWindow.prototype.show = function() {
  this.visible = true;
  this.initialize();
  this.drawContent();
}

LO.DisplayWindow.prototype.hide = function() {
  this.visible = false;
  this.game.display.container.removeChild(this.container);
}

LO.DisplayWindow.prototype.drawContent = function() {
...
LO.DisplayWindow.prototype.drawTitle = function() {
...
LO.DisplayWindow.prototype.drawCloseButton = function() {
...
LO.DisplayWindow.prototype.drawContentText = function(text, wordWrapWidth, posY) {
